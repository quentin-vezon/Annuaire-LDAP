...
$messages['fr']['minspecial'] = "Votre mot de passe n'a pas assez de caractères spéciaux";
...
$messages['fr']['policyminspecial'] = 'Nombre minimum de caractères spéciaux (sauf @, # et ")&nbsp;:';
